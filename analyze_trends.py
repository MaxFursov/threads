...
Завдання:
1. Коротко опиши (2-3 речення): які теми та стилі зараз популярні, чому люди реагують.
2. Напиши один пост від імені компанії "Ділова Ковбаса" (B2B постачальник м'ясних виробів, сайт dilovakovbasa.ua) — в дусі поточних трендів. Може бути контроверсійним, з провокаційним питанням, думкою. Головне — щоб зачіпало і хотілося відповісти.

Формат відповіді:
АНАЛІЗ: [аналіз трендів]
ПОСТ: [готовий текст посту, без markdown, без зірочок]"""
        }],
    )
